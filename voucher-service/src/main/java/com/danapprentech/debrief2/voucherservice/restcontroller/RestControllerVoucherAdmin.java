...
public class RestControllerVoucherAdmin
{
    ...
    public ResponseEntity<?> filterByStatus(
            ...
            @RequestParam(defaultValue = "voucherName") String sortBy)
    {
        return restControllerService.filterByStatus(page,filterByStatus,sortBy);
    }
    ...
    {
        return restControllerService.findByMerchantName(page,merchantName,sortBy);
    }
    ...
    {
        return restControllerService.voucherDetail(idVoucher);
    }
    ...
    {
        return restControllerService.updateVoucher(idVoucher,updateVoucherRequest);
    }
