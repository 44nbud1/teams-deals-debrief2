...
//    {
//
//        return createOutletService.createVoucher(idMerchant,idUser,voucherRequest,httpServletRequest);
//
...
////                Voucher voucher = voucherService.findByVoucherName(voucherRequest.getVoucherName());
////
////                // response
...
//    {
//
//        return createOutletService.filterByStatus(page,filterByStatus,sortBy);
////        Boolean status;
...
//    public ResponseEntity<?> voucherDetail(@PathVariable Long idVoucher)
//
//    {
//
//        return createOutletService.voucherDetail(idVoucher);
...
//    {
//
//        return createOutletService.updateVoucher(idVoucher,updateVoucherRequest);
////        Boolean status = null;
////
