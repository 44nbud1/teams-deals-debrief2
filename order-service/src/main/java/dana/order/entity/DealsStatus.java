...
public enum DealsStatus {
    ...
    TRANSACTION_HISTORY_COLLECTED("039", "Transaction history are successfully collected.", HttpStatus.OK),
    PAGE_NOT_FOUND("038", "Page not found.", HttpStatus.NOT_FOUND),
    DETAILED_HISTORY_COLLECTED("037", "Transaction history are successfully collected.", HttpStatus.OK),
