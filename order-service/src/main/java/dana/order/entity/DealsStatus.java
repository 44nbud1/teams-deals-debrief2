...
public enum DealsStatus {
    ...
    MINIMUM_TOPUP("035", "Minimum TOPUP amount is Rp 10.000,00",HttpStatus.FORBIDDEN),
    ...
    HISTORY_INVALID_CATEGORY("074", "Category only consist of COMPLETED and IN-PROGRESS content.", HttpStatus.BAD_REQUEST),
